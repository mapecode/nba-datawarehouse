...
Desarrollamos tres \textit{scripts} en \textit{Python} utilizando técnicas de \textit{web scrapping} para obtener datos de jugadores, \textit{rookies} y equipos de \href{https://www.basketball-reference.com/leagues/NBA_2019.html}{\textit{Basketball Reference}}
